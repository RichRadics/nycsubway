...
var colorlegend = function (target, scale, type, options) {
  var scaleTypes = ['linear', 'quantile', 'ordinal']
    ...
    , boundingRect = htmlElement.getBoundingClientRect()
    , w = boundingRect.width           // width of container element
    , h = boundingRect.height          // height of container element
    , colors = []
    , padding = [4, 6, 10, 6]               // top, right, bottom, left
